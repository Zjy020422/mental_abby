...
class MDQAnalyzer:
    ...
    def _generate_clinical_recommendations(self, current_state: Dict, historical_analysis: Dict, improvement_analysis: Dict) -> Dict:
        ...
        elif severity == SeverityLevel.HIGH_RISK or raw_score >= 20:
            recommendations.extend([
                "48小时内安排精神科专科评估",
                "加强门诊监测频率",
                "评估药物治疗调整需求",
        ...
        elif severity == SeverityLevel.MODERATE_RISK or raw_score >= 12:
            recommendations.extend([
                "1-2周内安排专科随访",
                "继续当前治疗方案并评估效果",
                "加强心理社会支持",
        ...
        elif severity == SeverityLevel.MILD_RISK or raw_score >= 6:
            recommendations.extend([
                "维持常规随访计划",
                "关注症状变化趋势",
                "加强生活方式管理",
